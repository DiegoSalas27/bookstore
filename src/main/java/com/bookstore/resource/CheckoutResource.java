...
public class CheckoutResource {
    ...
    public Order checkoutPost(@RequestBody HashMap<String, Object> mapper, Principal principal){
        ...
        ObjectMapper om = new ObjectMapper(); //here we extract the info from the hashmap
        ...
        Order order = orderService.createOrder(shoppingCart, shippingAddress, billingAddress,
            payment, shippingMethod, user);
